...
# -*- coding: utf-8 -*-
"""
Created on Tue Feb 12 16:09:30 2019
...
# -*- coding: utf-8 -*-
"""
Created on Fri Feb  8 12:10:57 2019
            ...
            output.insert(r,
                          Bunch(conditions = ['GainRisk','GainAmb', 'LossRisk','LossAmb'],
                                onsets = [list(eventsTotal[r][eventsTotal[r].condName=='GainRisk'].onset),
                                         list(eventsTotal[r][eventsTotal[r].condName=='GainAmb'].onset),list([0,0]),list([0,0])],
...
# create simple function to omit task-7
#def omitSeven(fileList):
#    print(fileList)
#    if len(fileList) > 4:
#        print ("Should remove")
#        fileList.pop()
...
#    return fileList
#    #
#omitSeven = Node(util.Function(input_names=['fileList'],
...
contrasts=[GainRisk_cond, GainAmb_cond, LossRisk_cond, LossAmb_cond, Risk_vs_Amb, Gain_vs_Loss, gain_total]
...
Image(filename="/media/Data/work/l1run/workflow_graph.png")
wf.write_graph(graph2use='flat')


wf.write_graph(graph2use='flat')
Image(filename = '/media/Data/work/l1run/graph_detailed.png')
wf.run('MultiProc') #, plugin_args={'n_procs': 5})                          
...
contrast_list = ['con_0001', 'con_0002', 'con_0003', 'con_0004', 'con_0005', 'con_0006', 'ess_0007']
...
plot_glass_brain(
    '/media/Data/work/l1runAllcond/_subject_id_1063/contrastestimate/spmT_0001.nii', colorbar=True,
     threshold=3.6, display_mode='lyrz', black_bg=True, vmax=10);       
        
        
plot_stat_map(
    '/media/Data/work/l1runAllcond/_subject_id_1063/contrastestimate/spmT_0001.nii',
    threshold=3.6, vmax=8, display_mode='ortho');    